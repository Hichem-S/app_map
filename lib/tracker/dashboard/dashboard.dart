...
import 'package:smart_inventory/tracker/item_management/refresh_action.dart';
import 'package:provider/provider.dart';
import 'package:smart_inventory/tracker/accessory/accessory_registry.dart';
import 'package:smart_inventory/tracker/dashboard/accessory_map_list_vert.dart';
import 'package:smart_inventory/tracker/item_management/item_management.dart';
import 'package:smart_inventory/tracker/item_management/new_item_action.dart';
import 'package:smart_inventory/tracker/location/location_model.dart';
import 'package:smart_inventory/tracker/preferences/preferences_page.dart';
import 'package:smart_inventory/tracker/preferences/user_preferences_model.dart';
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              onPressed: () =>
                  Navigator.pushNamed(context, '/tracker-management'),
              icon: const Icon(Icons.manage_search_rounded),
              tooltip: 'Tracker Management',
            ),
            IconButton(
              onPressed: () {
                Navigator.push(
