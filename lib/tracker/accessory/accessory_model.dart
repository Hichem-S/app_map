...
import 'package:smart_inventory/tracker/accessory/accessory_battery.dart';
...
class Accessory {
  ...
  static Color _parseColor(dynamic raw) {
    try {
      ...
      return Color(int.parse(str.substring(0, 8), radix: 16));
    } catch (_) {
      return Colors.grey;
    }
  }
  ...
  Accessory.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        isActive = (json['isDeployed'] ?? json['isActive']) as bool? ?? true,
        _icon = (json['icon'] as String?) ?? 'mappin',
