...
class GEDepartmentScreen extends StatefulWidget {
  const GEDepartmentScreen({super.key});

  @override
  State<GEDepartmentScreen> createState() => _GEDepartmentScreenState();
}

class _GEDepartmentScreenState extends State<GEDepartmentScreen> {
  static const Color _orange = Color(0xFFFF9100);
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.electrical_services, color: Colors.white, size: 40),
                      ),
                      const SizedBox(width: 15),
                      const Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text("GE", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                          ...
                          MaterialPageRoute(
                            builder: (_) => RoomItemsScreen(
                              ...
                              department: const Department(
                                id: '', code: 'E', name: 'Génie Électrique', color: 'FF9100'),
                            ),
                          ),
                        ),
                    ...
                    child: Row(
                      children: [
                        CircleAvatar(
                          ...
                          child: const Text("DL", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                        ),
                        const SizedBox(width: 15),
                        const Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            Text("Chef de département — GE", style: TextStyle(color: Colors.grey)),
                          ],
                        ),
                      ],
                    ),
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.qr_code_2_rounded, color: _orange, size: 22),
                  ),
